...
exports.getCheckoutSession = catchAsync(async (req, res, next) => {
  ...
  const session = await stripe.checkout.sessions.create({
    ...
    //   req.params.tourID
    // }`,
    success_url: `${req.protocol}://https://condescending-raman-59b7f8.netlify.app/myBookings`,
    cancel_url: `${req.protocol}://https://condescending-raman-59b7f8.netlify.app/tour/${req.params.tourID}`,
